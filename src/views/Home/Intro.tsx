    ...
    <div className="container mx-auto mb-10 flex w-full flex-col  items-center justify-around gap-8 p-5 md:flex-row  md:px-20">
      <section className="flex flex-col gap-12 md:w-1/2 ">
        ...
        <p className="w-full font-poppins text-base font-light tracking-widest">
          ...
          cryptocurrency market that mirrors the benefits of
          ...
          crypto-fund platform that enables the creation and
          self-management of tokenised basket funds. 
          <br />
          <br />
          Poised to empower the next generation of fund managers, Alvara is transforming the industry
          landscape. 
          <br />
          <br />
          Embrace the future of Decentralised Finance (DeFi). Welcome to
          the Alvara Protocol.
        </p>
      </section>
      <NextImage
