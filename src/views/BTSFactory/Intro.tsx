...
export default function Intro() {
  return (
    <section className="flex flex-col bg-slate-900 text-white">
      ...
      <div className="mx-[20px] mt-[82px] flex flex-col items-end justify-between gap-[15px] rounded-lg border-2 border-white border-opacity-20 bg-gray-900 px-[20px] py-[49px] md:mx-[60px] md:mt-[63px] md:px-[35px] xl:mx-[100px] xl:flex-row xl:items-center 2xl:mx-[214px]">
        <div className="flex flex-col gap-7">
          ...
          <h4 className={['opacity-80', styles.context].join(' ')}>
            ...
            within crypto markets or take advantage of other skilled traders by
      ...
      <div className="mx-[20px] mt-[82px] flex flex-col gap-[28px] md:mx-[60px] lg:flex-row lg:gap-[33px] xl:mx-[100px] 2xl:mx-[214px]">
        <div className="flex w-full flex-col gap-[28px] rounded-lg border border-white border-opacity-20 bg-gray-900 px-[20px] py-[66px] md:px-[35px]">
          ...
          <h4 className={['opacity-80', styles.context].join(' ')}>
            Four easy steps to create your first basket of tokens, we handle all
            of the complexity on the backend ;)
          </h4>
      ...
      <div className="mx-[20px] mt-[82px] flex flex-col gap-[28px] md:mx-[60px] lg:flex-row lg:gap-[33px] xl:mx-[100px] 2xl:mx-[214px]">
        <div className="relative flex w-full flex-col gap-[28px] rounded-lg border border-white border-opacity-20 bg-gray-900 px-[20px] py-[66px] md:px-[35px]">
          ...
          />
          <h3 className={['', styles.context_title].join(' ')}>Minting fees</h3>
          <h4 className={['font-light opacity-80', styles.context].join(' ')}>
        ...
        <div className="relative flex w-full flex-col gap-[28px] rounded-lg border border-white border-opacity-20 bg-gray-900 px-[20px] py-[66px] md:px-[35px]">
          ...
          <h4 className={['font-light opacity-80', styles.context].join(' ')}>
            To prevent the frivolous creation of numerous ERC-BTSs, we have set
            a minimum creation amount. The creator holds the ERC-BTS token and
            BTS LP tokens, which only represent their personal capital
      ...
      <div className="mx-[20px] mb-[41px] mt-[70px] flex items-center justify-center md:mx-[60px] lg:mb-[200px] lg:mt-[306px] xl:mx-[100px] 2xl:mx-[214px]">
        <Zoom>
          <div>
